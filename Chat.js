...
$(document).ready(function() {
	...
	function divItem(){
		...
		*/
		...
		$('#chatText').append('<div class="row"><div class="col-10"><div class="message received mb-3"><div class="message-content chatboxrecibido p-3"><p class="mb-0">' + $("#talk").val() + 
		'</p><small class="cardchatstime d-block mt-1">10:20 AM</small></div></div></div><div class="col-2"><img src="img/melissaprofile.png" class="rounded-circle" alt="@Maestro_shifu" width="40px"></div></div>');
